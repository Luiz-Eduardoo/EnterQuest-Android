...
public class ChamadoTecnicoAdapter extends BaseAdapter {

    private Context context;
    private List<Chamado> listaChamados;

    public ChamadoTecnicoAdapter(Context context, List<Chamado> listaChamados) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_chamado_tecnico, parent, false);
        }
